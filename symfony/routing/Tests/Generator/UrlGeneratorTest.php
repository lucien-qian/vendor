...
class UrlGeneratorTest extends TestCase
{
    ...
    public function testGenerateRelativePath()
    {
        ...
        $routes->add('task', new Route('/{author}/{task}/'));
        $routes->add('comments', new Route('/{author}/{task}/comments'));
        $routes->add('host', new Route('/{task}', array(), array(), array(), '{author}.example.com'));
        ...
        $this->assertSame('comments', $generator->generate('comments',
            array('author' => 'fabien', 'task' => 'symfony-is-great'), UrlGeneratorInterface::RELATIVE_PATH)
        );
        $this->assertSame('comments?page=2', $generator->generate('comments',
            array('author' => 'fabien', 'task' => 'symfony-is-great', 'page' => 2), UrlGeneratorInterface::RELATIVE_PATH)
        );
        $this->assertSame('../twig-is-great/', $generator->generate('task',
            array('author' => 'fabien', 'task' => 'twig-is-great'), UrlGeneratorInterface::RELATIVE_PATH)
        );
        $this->assertSame('../../bernhard/forms-are-great/', $generator->generate('task',
            array('author' => 'bernhard', 'task' => 'forms-are-great'), UrlGeneratorInterface::RELATIVE_PATH)
        );
